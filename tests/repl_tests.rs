...
mod tests {
    ...
    #[test]
    fn input_area_empty() {
        let paragraph = ReplUi::build_input_paragraph("", 0, false, None, None, 0);
    ...
    fn input_area_cursor_start() {
        let paragraph = ReplUi::build_input_paragraph("Hello", 0, false, None, None, 0);
        let terminal = render_widget(paragraph, 60, 3);
        let lines = buffer_to_lines(terminal.backend());
    ...
    fn input_area_cursor_middle() {
        let paragraph = ReplUi::build_input_paragraph("Hello", 2, false, None, None, 0);
        let terminal = render_widget(paragraph, 60, 3);
        let lines = buffer_to_lines(terminal.backend());
    ...
    fn input_area_cursor_end() {
        let paragraph = ReplUi::build_input_paragraph("Hello", 5, false, None, None, 0);
        let terminal = render_widget(paragraph, 60, 3);
        let lines = buffer_to_lines(terminal.backend());
